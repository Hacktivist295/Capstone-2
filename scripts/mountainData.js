...
dropdown.addEventListener("change", function () {
    const selectedMountain = mountains[this.value];
    mountainName.textContent = selectedMountain.name;
    mountainDescription.textContent = selectedMountain.description;
    mountainImage.src = selectedMountain.image;
    mountainElevation.textContent = `Elevation: ${selectedMountain.elevation} meters`;
});
